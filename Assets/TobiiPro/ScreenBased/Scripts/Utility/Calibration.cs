...
namespace Tobii.Research.Unity
{
    public class Calibration : MonoBehaviour
    {
        ...
        {
            float scaleRatio = 1;
            if (eyeTrackRect != null)
            {
                Vector3 vec = eyeTrackRect.localScale;
                scaleRatio = vec.x;
            }
            if (points != null)
            {
            ...
            {
                // var newPosition = pointPosition;
                // if (scaleRatio != 1)
                // {
                //     float posX = pointPosition.x;
                //     float posY = pointPosition.y;
                //     newPosition = new Vector2(CalculateScale(posX, scaleRatio), CalculateScale(posY, scaleRatio));
                // }
        ...
        // private float CalculateScale(float value, float ratio)
        // {
        //     if (value >= 0.5)
        //     {
        //         return 0.5f + value * ratio - 0.5f * ratio;
        //     }
        //     else
        //     {
        //         return 0.5f - 0.5f * ratio + value * ratio;
        //     }
        // }
    }
}
